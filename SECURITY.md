...
The preferred channel is GitHub's [private vulnerability reporting](https://docs.github.com/en/code-security/security-advisories/guidance-on-reporting-and-writing-information-about-vulnerabilities/privately-reporting-a-security-vulnerability) feature on this repository: navigate to the **Security** tab → **Report a vulnerability**. This is end-to-end encrypted between you and the maintainers, and creates a tracked advisory once acknowledged.
