...
// Note: the ./pletka and ./pletka-platform/ops staging modules are disabled
// for now (removed from go.work and from the require/replace set here). The
// root module is self-contained. They will be re-enabled when the core is
// ready for the public/platform split.
